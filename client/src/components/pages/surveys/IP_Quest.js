...
class IP_Quest extends React.Component {
    ...
    render() {
        ...
        const education_lvl = ["N/A", "High School Diploma", "Some College", "Associates Degree", "Bachelors Degree", "Masters Degree", "PhD"]
        ...
        return (
            <div>
                ...
                <RadioBtn
                    ...
                    question="How many embryos do you want to implant?"
                    listOptions={embr_ct}
                />
                <EitherOr
                    fieldId="married_ind"
                ...
                <Slide
                    ...
                    question="How willing are you to allow your Surrogate or Gestational Carrier to give birth at a birthing center?"
                />
                <EitherOr
                    fieldId="hosp_birth"
                    key="hosp_birth"
